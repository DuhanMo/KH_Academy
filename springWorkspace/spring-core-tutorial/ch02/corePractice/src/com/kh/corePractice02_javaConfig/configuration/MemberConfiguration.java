...
// @Configuration , @Bean , @Component, @Repository, @Service, @Controller 가
//달린 클래스를 모두 감지 
@Configuration
...
// 스캐닝에 포함할 내용을 작성
		includeFilters = { @ComponentScan.Filter(type = FilterType.REGEX, pattern = {
				"com.kh.corePractice02_javaConfig.*Dao", "com.kh.corePractice02_javaConfig.*Service" })
...
public class MemberConfiguration {
	//exclude로 제외했기 때문에 MemberDao 객체를 찾지 못한다.
	@Bean
