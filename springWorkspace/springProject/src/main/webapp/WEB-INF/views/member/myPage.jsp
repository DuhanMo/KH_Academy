	...
	<div class="outer" align="center">
		<form action="mupdate.do" method="post" id="joinForm">
			<table width="500" cellspacing="5">
				<tr>
					<td width="150">* 아이디</td>
					<td><input type="text" name="id" id="userId" value="${loginUser.id}" readonly></td>
				</tr>
				<tr>
					<td>* 이름</td>
               ...
               <td><input type="password" name="pwd2" required></td>
				...
				<c:if test="${ !empty loginUser.address }">
					<c:forTokens var="addr" items="${ loginUser.address }" delims="," varStatus="status">
						<c:if test="${ status.index eq 0 }">
							<tr>
								<td>우편번호</td>
								<td><input type="text" name="post" class="postcodify_postcode5" size="6" value="${ addr }">
									<button type="button" id="postcodify_search_button">검색</button></td>
							</tr>
						</c:if>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<button type="button" onclick="location.href='${mdelete}';">탈퇴하기</button> &nbsp; <input type="reset" value="취소하기">
					</td>
				</tr>
			</table>
		</form>
